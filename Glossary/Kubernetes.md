...
Example: An application might have a liveness probe that checks if it's still responsive, automatically restarting it if it becomes deadlocked or otherwise unresponsive.