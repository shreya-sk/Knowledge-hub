...
Example: A high availability database might use multiple nodes across different availability zones, with automatic failover if the primary node becomes unavailable.