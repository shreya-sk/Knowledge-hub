...
Example: An e-commerce site might use container orchestration to automatically scale up the number of web server containers during a sales event to handle increased traffic.